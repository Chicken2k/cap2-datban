...
function Tour(props) {
  ...
  return (
    <div id="detail-tour">
      <div className="breadcrumb">
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item"><Link to="/list-tour">Đặt bàn</Link></li>
                ...
                <div className="col-lg-4 position-relative ">
                  <div className=" pl-3">
                    ...
                    <div className="tt-tour">
                      <table className="w-100">
                        ...
                        <tr>
                          ...
                          <td><span>{ok.thoigian} giờ</span></td>
                        </tr>
                      </table>
                    </div>
                    ...
                    <div className="price position-absolute">
                      {tour_ngay.map(ok => (
                        <span  key={ok.id}> Chỉ từ <strong className="text-danger abc">{(thanhtien(ok.gianguoilon,ok.giatreem, ok.giaembe)).toLocaleString()}</strong> K/Người</span>
                      ))}                      
                      <br />
      ...
      >
        <h4 className="text-center text-primary">Hình thức đặt cọc</h4>
