                ...
                <div className="box-login">
                    <form className="form" onSubmit={onsubmit}>
                        ...
                        <div className="input-group flex-nowrap">
                            ...
                            <input type="text" className="form-control text-chu" placeholder="Tài khoản" value={email} name='email' onChange={onchange} aria-label="email" aria-describedby="addon-wrapping" />
                        </div>
                        ...
                        <div className="input-group flex-nowrap mt-3 mb-3">
                            ...
                            <input type="password" className="form-control text-chu" placeholder="Mật khẩu" value={password} name="password" onChange={onchange} aria-label="email" aria-describedby="addon-wrapping" />
                        </div>

                        <div className="form-group form-check">
                            <label className="form-check-label">
                                <input className="form-check-input" type="checkbox" onChange="onclick" /> <span className="text-black">Nhớ mật khẩu</span>
                            </label>
                            <Link to="#" onClick={hangdleDK} className="float-right text-black">Chưa có tài khoản?</Link>
                        </div>
