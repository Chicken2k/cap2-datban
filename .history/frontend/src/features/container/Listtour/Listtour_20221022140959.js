            ...
            <div className="breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item"><Link to="/list-tour" disabled>Đặt bàn</Link></li>
                    </ol>
                </nav>
            </div>
            <div className="container">
                <div className="row mb-4 bg-white rounded">
                    <div className="col-md-3 border-right pb-3 bg chungtoi">
                        <h4 className="pt-4">Tìm Kiếm nhà hàng</h4>
                        <Search placeholder="Tìm kiếm tour" onSearch={search} enterButton />

                        <h4 className="mt-3">Khu vực</h4>
                        <Select className="w-100" defaultValue="trong" style={{ width: 120 }} onChange={handleChange}>
                            <Option value="trong">NHÀ HÀNG TRONG THÀNH PHỐ</Option>
                            <Option value="ngoai">NHÀ HÀNG NGOÀI THÀNH PHỐ</Option>
                        </Select>
                        {/* {state.check === "trong" ?
                            <div>
                    ...
                    <div className="col-md-9">
                        <div className="title text-center mt-3">
                            {state.check === 'trong' ? <h3>Nhà hàng trong khu vực </h3> : <h3>Nhà hàng ngoài thành phố</h3>}
                                                ...
                                                <div className="col-md-6 mb-3">
                                                    <Link to={`/tour/${ok.id}`}>
                                                        ...
                                                        <div className="content_tour">
                                                            ...
                                                            Chỉ từ {(ok.gianguoilon).toLocaleString()}K/Người<br />
                                                            </div>
                                                        </div>
                                                    </Link>
                                                </div>
                                                ...
                                                <div className="col-md-6 mb-3">
                                                    <Link to={`/tour/${ok.id}`}>
                                                        ...
                                                        <div className="content_tour">
                                                            ...
                                                            <div className="money float-left ml-3 text-warning">
                                                            <div>
                        Chỉ từ {ok.gianguoilon.toLocaleString()}K/Người
                          <br />
                        </div>
                                                            </div>
                                                        </div>
