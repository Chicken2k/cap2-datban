...
function Tintuc(props) {
  ...
  return (
    <div id="news">
      ...
      <button class="xem-them custom-btn btn-6"><span> 
      <Linkrt to="/listtintuc">Xem Thêm &gt;&gt;</Linkrt></span>
      </button>
          ...
          <div className="card card--feedback">
            <div className="card-body">
              ...
              <p className="card-text">
                Đầu tiên về dịch vụ, mình đánh giá 2 từ thôi: Tuyệt vời ? Nhà
                hàng sạch sẽ , món ăn ngon và rẻ , đáng để thử nha mọi người .
                Duyệt!
              </p>
            </div>
          </div>
